...
const BookDetailPage = () => {
  ...
  if (error || !book) return <div className="min-h-screen flex items-center justify-center">{error || "Book not found"}</div>;
  ...
  return (
    <div className="min-h-screen bg-[#f2f4f1] py-8">
      <main className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-1">
            {book.coverImage ? (
              ...
              <div className="w-full h-64 bg-gray-100 flex items-center justify-center text-gray-400">No Cover</div>
            )}
          </div>
        ...
        {/* Full Description - ফুল উইথ সেকশন */}
